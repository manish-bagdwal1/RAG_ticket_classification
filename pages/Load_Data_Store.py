...
def main():
    ...
    if pdf is not None:
        with st.spinner('Wait for it...'):
            ...
            import os
            os.environ["PINECONE_API_KEY"] = "56d1a14d-f9a3-46b7-8f91-71def7a97b7b"
            push_to_pinecone(os.getenv("PINECONE_API_KEY"),"gcp-starter","mcq-creater",embeddings,docs_chunks)
